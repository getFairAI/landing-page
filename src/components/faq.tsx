  ...
  return (
    <section className='mt-10 flex justify-center'>
      <div className='container card-glasspane-container w-[90%] max-w-[1800px] p-14'>
        <div className='w-[100%] flex gap-10 flex-wrap sm:flex-nowrap'>
          <div className='sm:justify-start sm:w-[100%] md:w-[30%] flex flex-col text-center'>
            <h2
              className='flex text-2xl md:text-3xl py-1 font-bold '
